...
namespace FoodOnFinger.Controllers
{
    public class CuisinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CuisineID,Name,Description")] Cuisine cuisine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CuisineID,Name,Description")] Cuisine cuisine)
        {
            if (ModelState.IsValid)
            {
